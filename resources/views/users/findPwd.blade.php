...
<section class="zyw-container">
    ...
    <div class="weui-cell weui-cell_vcode">
        ...
        <div class="weui-cell__ft">
            <button class="weui-vcode-btn theme-color" data='/login/sendSmsCode'>获取验证码</button>
        </div>
    </div>
    <div class="weui-cell">
        <div class="weui-cell__hd"><label class="weui-label">密码</label></div>
        <div class="weui-cell__bd">
            <input class="weui-input" id="password" type="password" placeholder="请输入6-20位密码">
    ...
    <div class="login-btn"><a href="javascript:;" class="weui-btn weui-btn_warn theme-bgcolor findPwd-submit">提交</a></div>
</section>
