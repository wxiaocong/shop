...
class WechatController extends Controller
{
    ...
    public function wechatRefunc()
    {
        ...
        //     ));
        // } else {
            $refundSn = '20180929202117100100102920230320'.time();//$orderInfo->order_sn.time();
            ...
            OrderRefundService::wechatRefundByTransactionId($transaction_id, $refundSn, 198, $money);
            //查询退款
