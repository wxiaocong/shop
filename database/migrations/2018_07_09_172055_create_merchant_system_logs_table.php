...
/**
 *--------------------------------------------------------------------------
 * create merchant_system_logs table
 *--------------------------------------------------------------------------
 *
 * @author caopei(caopei@carnetmotor.com)
 *
 */
class CreateMerchantSystemLogsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('merchant_system_logs', function (Blueprint $table) {
            $table->increments('id');
            $table->timestamps();
            $table->softDeletes();
    ...
    {
        Schema::drop('merchant_system_logs');
    }
}
